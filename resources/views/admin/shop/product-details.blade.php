                            ...
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-3 col-4">
                                                <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                    <a class="nav-link active" id="product-0-tab" data-bs-toggle="pill" href="#product-0" role="tab" aria-controls="product-0" aria-selected="false">
                                                        <img src="{{ asset($product->thumbnail ?? 'admin/assets/images/empty.png') }}" alt="" class="img-fluid mx-auto d-block rounded">
                                                    </a>
                                                    @foreach ($product_image as $key => $item)
                                                        <a class="nav-link" id="product-{{ $key + 1 }}-tab" data-bs-toggle="pill" href="#product-{{ $key + 1 }}" role="tab" aria-controls="product-{{ $key + 1 }}" aria-selected="false">
                                                            <img src="{{ asset($item->image ?? 'admin/assets/images/empty.png') }}" alt="" class="img-fluid mx-auto d-block rounded">
                                                        </a>
                                                    @endforeach
                                                </div>
                                            </div>
                                            <div class="col-md-7 offset-md-1 col-sm-9 col-8">
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    <div class="tab-pane fade show active" id="product-0" role="tabpanel" aria-labelledby="product-0-tab">
                                                        <div>
                                                            <img src="{{ asset($product->thumbnail ?? 'admin/assets/images/empty.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                        </div>
                                                    </div>
                                                    @foreach ($product_image as $key => $item)
                                                        <div class="tab-pane fade" id="product-{{ $key + 1 }}" role="tabpanel" aria-labelledby="product-{{ $key + 1 }}-tab">
                                                            <div>
                                                                <img src="{{ asset($item->image ?? 'admin/assets/images/empty.png') }}" alt="" class="img-fluid mx-auto d-block">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="mt-4 mt-xl-3">
                                        ...
                                        <h5 class="mb-4">Price : 
                                            @if ($product->discount)
                                                <span class="text-muted me-2"><del>৳ {{ $product->price }}</del></span> <b>৳ {{ $product->discount }}</b>
                                            @else
                                                <b>৳ {{ $product->price }}</b>
                                            @endif
                                        </h5>
                                        <p class="text-muted mb-4">{{ $product->summary }}</p>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="d-flex py-3 border-bottom">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="{{ asset('admin/assets/images/users/avatar-2.jpg') }}" class="avatar-xs rounded-circle" alt="img" />
                                    </div>
                                ...
                                <div class="d-flex py-3 border-bottom">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="{{ asset('admin/assets/images/users/avatar-4.jpg') }}" class="avatar-xs rounded-circle" alt="img" />
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex mt-4">
                                            <div class="flex-shrink-0 me-2">
                                                <img src="{{ asset('admin/assets/images/users/avatar-5.jpg') }}" class="avatar-xs me-3 rounded-circle" alt="img" />
                                            </div>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-md-4">
                                                <img src="{{ asset('admin/assets/images/product/img-4.png') }}" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="text-center text-md-start pt-3 pt-md-0">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-md-4">
                                                <img src="{{ asset('admin/assets/images/product/img-6.png') }}" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="text-center text-md-start pt-3 pt-md-0">
