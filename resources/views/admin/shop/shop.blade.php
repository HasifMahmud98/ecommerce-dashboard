                    ...
                    <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="product-img position-relative">
                                            ...
                                            <img src="{{ $item->thumbnail }}" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                        <div class="mt-4 text-center">
                                            <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">{{ $item->name }} </a></h5>
                        ...
                        {{-- <div class="col-xl-4 col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img position-relative">
                                        <img src="{{ asset('admin/assets/images/product/img-2.png') }}" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                    <div class="mt-4 text-center">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img position-relative">
                                        ...
                                        <img src="{{ asset('admin/assets/images/product/img-3.png') }}" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                    <div class="mt-4 text-center">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="product-img position-relative">
                                        ...
                                        <img src="{{ asset('admin/assets/images/product/img-5.png') }}" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                    <div class="mt-4 text-center">
